...
#...und laden der Einstellungen
    def load_settings(self):
        ...
        self.change_output_directory(self)
        ...
        self.ui.cb_prealing_images.setEnabled(self.ui.cb_rigid_registration.isChecked())
        ...
        if(len(self.myFileList)):
            ...
            if (checked):
                ...
                for file in self.myProcessList:
                    ...
                    if(self.ui.cb_create_mask.isChecked() and self.ui.rb_mask_subject.isChecked()):
